      ...
      <div style={styles.shell}>
        ...
        {view === "intro" && (
          <div className="yn-fadein" style={styles.introWrap}>
            <div style={styles.introLogo}><YnoveLogo height={76} /></div>
...
// Arquivos em /public/. Se a pasta não subir no deploy, a logo cai para o
// texto "YNOVE" e o mascote some — sem quebrar a tela. Ambos os arquivos
// PRECISAM estar em /public/ para a identidade aparecer.
function Mascote({ size = 132 }) {
  const [erro, setErro] = useState(false);
  if (erro) return null;
  const arq = "/mascote-ynove-busto.jpg";
  return (
    <img
      src={arq}
      alt="Mascote YNOVE"
